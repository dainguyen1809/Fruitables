                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="dash-campaigns-chart" class="apex-charts"
                                        data-colors="#40c391,#ffa866,#44badc"></div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-sm table-nowrap table-centered mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <h5 class="font-15 mb-1 font-weight-normal">
                                                            Jeremy Young
                                                        </h5>
                        ...
                        <div class="col-xl-4 col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="media">
                                        <img class="mr-3 rounded-circle" src="assets/images/users/avatar-2.jpg"
                                    ...
                                    <div class="media mt-3">
                                        <img class="mr-3 rounded-circle" src="assets/images/users/avatar-3.jpg"
                                            width="40" alt="Generic placeholder image" />
                                        <div class="media-body">
                                    ...
                                    <div class="media mt-3">
                                        <img class="mr-3 rounded-circle" src="assets/images/users/avatar-4.jpg"
                                            width="40" alt="Generic placeholder image" />
                                        <div class="media-body">
                                    ...
                                    <div class="media mt-3">
                                        <img class="mr-3 rounded-circle" src="assets/images/users/avatar-5.jpg"
                                            width="40" alt="Generic placeholder image" />
                                        <div class="media-body">
                                            <span class="badge badge-warning-lighten float-right">Cold lead</span>
                                    ...
                                    <div class="media mt-3">
                                        <img class="mr-3 rounded-circle" src="assets/images/users/avatar-1.jpg"
                                            width="40" alt="Generic placeholder image" />
                                        <div class="media-body">
                                            <span class="badge badge-warning-lighten float-right">Cold lead</span>
                                    ...
                                    <div class="media mt-3">
                                        <img class="mr-3 rounded-circle" src="assets/images/users/avatar-6.jpg"
                                            width="40" alt="Generic placeholder image" />
                                        <div class="media-body">
                                            <span class="badge badge-success-lighten float-right">Won lead</span>
